...
int main()
{
	...
	if (country == en_country_choice::Jordan)
	{
		cout << "Your country is Jordan\n";
	}
	else if (country == en_country_choice::Tunisia)
	{
		cout << "Your country is Tunisia\n";
	}
	else if (country == en_country_choice::Algeria)
	{
		cout << "Your country is Algeria\n";
	}
	else if (country == en_country_choice::Oman)
	{
		cout << "Your country is Oman\n";
	}
	else if (country == en_country_choice::Egypt)
	{
		cout << "Your country is Egypt\n";
	}
	else if (country == en_country_choice::Iraq)
	{
